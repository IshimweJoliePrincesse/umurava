    ...
    <div className="container mx-auto px-4 py-12 max-w-6xl">
      <div className="text-center mb-12">
        ...
        <p className="text-gray-600 max-w-2xl mx-auto">
          ...
          become part of Africa's larget workforce of digital professionals.
        </p>
      </div>
        ...
        <Card className="bg-[#2B71F0]">
          <CardContent className="p-8">
            ...
            <p className="text-white/90">
              Tacke real-world projects through challenges and hackathons that
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <Card className="bg-[#2B71F0] text-white">
            <CardContent className="p-8">
              ...
              <p className="text-white/90">
                elop the in-demand skills and build a strong portfolio to
          ...
          <Card className="bg-[#2B71F0] text-white">
            <CardContent className="p-8">
              ...
              <p className="text-white/90">
                ...
                contests and competitions by working on real word projects and
